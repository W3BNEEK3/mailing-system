            ...
            <tbody class="divide-y divide-slate-100">
                <?php foreach ($rows as $row): ?>
                    ...
                    <tr class="hover:bg-red-50/30 transition">
                        <td class="px-4 py-3 text-slate-500 whitespace-nowrap"><?= e($createdAt) ?></td>
                        <td class="px-4 py-3 text-slate-800 max-w-[200px]">
                        ...
                        <td class="px-4 py-3 text-red-600 max-w-[280px]">
                            <span class="truncate block text-xs font-mono" title="<?= e($row['error_message'] ?? '') ?>">
